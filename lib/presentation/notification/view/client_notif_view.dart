...
class ClientNotifView extends StatefulWidget {
  const ClientNotifView({super.key});

  @override
  State<ClientNotifView> createState() => _ClientNotifViewState();
}

class _ClientNotifViewState extends State<ClientNotifView> {
