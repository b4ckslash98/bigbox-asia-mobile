...
class Step4FinalSchedules extends BaseStep {
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              buildSectionTitle('Jadwal Final'),
              ElevatedButton.icon(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TextFormField(
                      ...
                      decoration: const InputDecoration(
                        labelText: 'Catatan',
                        hintText: 'Informasi tambahan tentang jadwal final',
                        border: OutlineInputBorder(),
                      ),
                      maxLines: 3,
                      onChanged: (value) {
          ...
          if (finalSchedules.isEmpty)
            Center(
              child: Padding(
                ...
                child: Text(
                  'Belum ada jadwal final. Klik "Tambah" untuk menambahkan jadwal.',
